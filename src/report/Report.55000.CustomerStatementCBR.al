report 55000 "Customer Statements CBR"
{
    DefaultLayout = RDLC;
    Caption = 'Customer Statements';
    RDLCLayout = './CustomerStatementsCBR.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem(HeaderFooter; "Integer")
            {
                ...
                column(Desc_Lbl; Desc_Lbl)
                {

                }
                column(RemAmt_Lbl; RemAmt_Lbl)
                {

                }
                column(OriAmt_Lbl; OriAmt_Lbl)
                {
                ...
                dataitem(OpenItem; "Integer")
                {
                    ...
                    column(TempCustLedgEntry_Description1; TempCustLedgEntry.Description)
                    {

                    }
                    column(TempCustLedgEntry_Original_Amount1; TempCustLedgEntry."Original Amount")
                    {
                    ...
                    begin
                        ...
                        TempCustLedgEntry.CalcFields("Remaining Amount", "Original Amount");
                        ...
                        if TempCustLedgEntry."Currency Code" <> Customer."Currency Code" then
                            TempCustLedgEntry."Original Amount" :=
                              Round(
                                CurrExchRate.ExchangeAmtFCYToFCY(
                                  TempCustLedgEntry."Posting Date",
                                  TempCustLedgEntry."Currency Code",
                ...
                dataitem(CustLedgerEntry4; "Cust. Ledger Entry")
                {
                    ...
                    column(CustLedgerEntry4_Original_Amount; "Original Amount")
                    {

                    }
                    column(CustLedgerEntry4_Remaining_Amount; "Remaining Amount")
                    {
                    ...
                    trigger OnAfterGetRecord()
                    begin
                        CalcFields(Amount, "Amount (LCY)", "Original Amount", "Remaining Amount");
    ...
    var
        ...
        Desc_Lbl: Label 'Description';
        RemAmt_Lbl: Label 'Remaining Amount';
        OriAmt_Lbl: Label 'Original Amount';
